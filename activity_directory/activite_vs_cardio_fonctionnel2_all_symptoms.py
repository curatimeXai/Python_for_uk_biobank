...
df = pd.read_csv('./intense_activity_via_Duration_of_heavy_DIY.csv',sep=";")
print("pret")
...
def historigram(data,a,duration,symptom):
    ...
    for l in liste_cvd:
        ...
        for i in duration:
            ...
            #indépendant du symptome, il vaut mieux la sortir pour ne pas alourdir la boucle
            for j in list2:
                condia_et_b=((z["Duration of heavy DIY | Instance 0"]==i) & (z["Vascular/heart problems diagnosed by doctor | Instance 0"]==j))
